USE [InstaFoodDb]
GO
/****** Object:  Table [dbo].[CartItems]    Script Date: 25-09-2024 07:58:02 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[DeliveryAddresses]    Script Date: 25-09-2024 07:58:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[OrderDetails]    Script Date: 25-09-2024 07:58:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Orders]    Script Date: 25-09-2024 07:58:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[OrderStatus]    Script Date: 25-09-2024 07:58:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Products]    Script Date: 25-09-2024 07:58:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Users]    Script Date: 25-09-2024 07:58:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[Orders] ([OrderId], [CustomerId], [OrderDate], [OrderTime], [TotalCost], [OrderStatusId]) VALUES (N'21968202', N'10831125', CAST(N'2024-09-18' AS Date), CAST(N'10:50:02.5592958' AS Time), 450, 1)
GO
...
GO
INSERT [dbo].[Products] ([ProductId], [ProductName], [ProductDescription], [UnitPrice], [ProductPicture], [IsAvailable]) VALUES (1011, N'Rogan Josh', N'A Kashmiri meal is incomplete without rogan josh. Made out of lamb, this aromatic dish is basically of Persian origin and is as delicious as its name.', 250, N'https://www.fabhotels.com/blog/wp-content/uploads/2016/11/Rogan-Josh-1.jpg', 1)
GO
INSERT [dbo].[Products] ([ProductId], [ProductName], [ProductDescription], [UnitPrice], [ProductPicture], [IsAvailable]) VALUES (1012, N'Makki-Roti and Sarso ka Saag', N'Who doesn’t love makke ki roti and sarso ka saag? Come winters and kitchens of Punjab are filled with the aroma of mustard.', 180, N'https://www.fabhotels.com/blog/wp-content/uploads/2024/01/8ce8cf5a-makki-roti-and-sarso-ka-saag.jpg:cf-webp:w-848:h-551', 1)
GO
INSERT [dbo].[Products] ([ProductId], [ProductName], [ProductDescription], [UnitPrice], [ProductPicture], [IsAvailable]) VALUES (1013, N'Chaach or Buttermilk', N'Chaach is a common drink consumed in almost every home in northern and central part of India.', 150, N'https://www.fabhotels.com/blog/wp-content/uploads/2024/01/66935255-chaach-or-buttermilk.jpg', 0)
GO
INSERT [dbo].[Products] ([ProductId], [ProductName], [ProductDescription], [UnitPrice], [ProductPicture], [IsAvailable]) VALUES (1014, N'Dal-Baati-Churma', N'This dish is a staple diet in Rajasthan. Land anywhere in the state – Udaipur, Jaipur, Jodhpur, Bikaner, you will find people having it.', 200, N'https://www.fabhotels.com/blog/wp-content/uploads/2016/11/Daal-baati-768x489-1.jpg', 1)
GO
INSERT [dbo].[Products] ([ProductId], [ProductName], [ProductDescription], [UnitPrice], [ProductPicture], [IsAvailable]) VALUES (1015, N'Sidu', N'A speciality from Kullu, Himachal Pradesh, Sidu is a kind of bread mostly eaten with dal or chutney.', 170, N'https://www.fabhotels.com/blog/wp-content/uploads/2016/11/hp2.jpg', 1)
GO
INSERT [dbo].[Products] ([ProductId], [ProductName], [ProductDescription], [UnitPrice], [ProductPicture], [IsAvailable]) VALUES (1016, N'Jhangora Kheer', N'Millets or jhangora ki kheer is a popular sweet dish in any Garhwal (in Uttarkhand) household. Its preparation is similar to the regular rice pudding except the rice is replaced by jhangora.', 160, N'https://www.fabhotels.com/blog/wp-content/uploads/2024/01/5765d049-kheer-min.jpg', 1)
GO
INSERT [dbo].[Products] ([ProductId], [ProductName], [ProductDescription], [UnitPrice], [ProductPicture], [IsAvailable]) VALUES (1017, N'Aloo Kachori', N'A common breakfast for North Indians especially in the state of Uttar Pradesh, aloo kachori is simply plain flour dough stuffed with lentils or potatoes with curry comprising tomatoes and potatoes.', 150, N'https://www.fabhotels.com/blog/wp-content/uploads/2016/11/KACHORI-2.jpg', 0)
GO
INSERT [dbo].[Products] ([ProductId], [ProductName], [ProductDescription], [UnitPrice], [ProductPicture], [IsAvailable]) VALUES (1018, N'Bhopali Kebab', N'Bhopali kebabs is a traditional recipe made out of mutton or beef. As the name goes, it’s a dish from Bhopal and hugely popular in Madhya Pradesh.', 220, N'https://www.fabhotels.com/blog/wp-content/uploads/2024/01/3d2d864d-bhopal-kebabs.jpg', 1)
GO
INSERT [dbo].[Products] ([ProductId], [ProductName], [ProductDescription], [UnitPrice], [ProductPicture], [IsAvailable]) VALUES (1019, N'Bafauri', N'A wonderful alternative to the oily pakoras India is used to having, bafauri is made from chickpeas but instead of frying, it is steamed.', 150, N'https://www.fabhotels.com/blog/wp-content/uploads/2016/11/Bafauri-1.jpg', 1)
GO
INSERT [dbo].[Products] ([ProductId], [ProductName], [ProductDescription], [UnitPrice], [ProductPicture], [IsAvailable]) VALUES (1020, N'Dosa', N'The light meal from South India that is eaten everywhere in India. Yes, we are talking about the every loved Dosa. Have it plain or with potato, it never seems to disappoint anyone.', 80, N'https://www.fabhotels.com/blog/wp-content/uploads/2016/11/dosa-1.jpg', 0)
GO
INSERT [dbo].[Products] ([ProductId], [ProductName], [ProductDescription], [UnitPrice], [ProductPicture], [IsAvailable]) VALUES (1021, N'Momos', N'How can we ever forget to add Momos in the list? Originally from Nepal, this dish is available at every corner of the street in the country and is loved by all of us.', 100, N'https://www.fabhotels.com/blog/wp-content/uploads/2020/01/Dumpling-food.jpg', 1)
GO
INSERT [dbo].[Products] ([ProductId], [ProductName], [ProductDescription], [UnitPrice], [ProductPicture], [IsAvailable]) VALUES (1022, N'Gajar ka Halwa', N'A highly popular dessert in the whole of country, Gajar ka halwa is basically grated carrots, milk, sugar and dry fruits. ', 150, N'https://www.fabhotels.com/blog/wp-content/uploads/2016/11/Gajar-ka-Halwa-1.jpg', 0)
GO
INSERT [dbo].[Products] ([ProductId], [ProductName], [ProductDescription], [UnitPrice], [ProductPicture], [IsAvailable]) VALUES (1024, N'Chicken Briyani', N'Chicken Briyani', 175, N'https://media.istockphoto.com/id/1333127665/photo/chicken-biryani-spicy-indian-malabar-biryani-hyderabadi-biryani-dum-biriyani-pulao-golden.jpg?s=612x612&w=0&k=20&c=63UXYPOISm8nJ8SNK79dDm0w1gY6jXzYQP0heL6fnOg=', 1)
GO
INSERT [dbo].[Products] ([ProductId], [ProductName], [ProductDescription], [UnitPrice], [ProductPicture], [IsAvailable]) VALUES (1029, N'Paratha', N'Paratha is another style of unleavened, whole-wheat flatbread and a quintessential Indian food. Thicker and more substantial than naan or chapati, paratha is prepared by coating the dough with ghee (a type of clarified butter) or oil and folding repeatedly, similar to making puff pastry, using a lamination technique.', 120, N'https://res.cloudinary.com/hz3gmuqw6/image/upload/c_fill,q_60,w_750,f_auto/3-paratha-canva-phpCTUMcP', 1)
GO
INSERT [dbo].[Products] ([ProductId], [ProductName], [ProductDescription], [UnitPrice], [ProductPicture], [IsAvailable]) VALUES (1030, N'Matar Kulcha', N'Another favorite street food from North India is matar kulcha. This simple snack consists of a soft flatbread served with spiced white pea gravy and is one of the most famous street foods in Delhi.', 200, N'https://res.cloudinary.com/hz3gmuqw6/image/upload/c_fill,q_60,w_750,f_auto/11-matar-kulcha-canva-phpiqTrzB', 1)
GO
INSERT [dbo].[Products] ([ProductId], [ProductName], [ProductDescription], [UnitPrice], [ProductPicture], [IsAvailable]) VALUES (1031, N'Kathi Rolls', N'Originally from Kolkata in the West Bengal state of India, kathi rolls began as a skewer-roasted kebab wrapped in paratha bread.', 250, N'https://res.cloudinary.com/hz3gmuqw6/image/upload/c_fill,q_60,w_750,f_auto/15-kathi-rolls-canva-phpE9mepi', 1)
GO
INSERT [dbo].[Products] ([ProductId], [ProductName], [ProductDescription], [UnitPrice], [ProductPicture], [IsAvailable]) VALUES (1032, N'Chicken 65', N'The spicy, deep-fried chicken dish appeared on the menu of the Buhari Hotel in the state of Tamil Nadu. ', 200, N'https://res.cloudinary.com/hz3gmuqw6/image/upload/c_fill,q_60,w_750,f_auto/19-chicken-65-canva-phpV0OB8z', 1)
GO
INSERT [dbo].[Products] ([ProductId], [ProductName], [ProductDescription], [UnitPrice], [ProductPicture], [IsAvailable]) VALUES (1033, N'Tandoori', N'An iconic food from India, dishes labeled tandoori are typically breads or meats that have been seasoned and cooked at high temperatures in a tandoor oven. Tandoori chicken is probably the most well-known dish of this style.', 350, N'https://res.cloudinary.com/hz3gmuqw6/image/upload/c_fill,q_60,w_750,f_auto/23-tandoor-canva-phpRi8NmQ', 1)
GO
INSERT [dbo].[Products] ([ProductId], [ProductName], [ProductDescription], [UnitPrice], [ProductPicture], [IsAvailable]) VALUES (1034, N'Kebab, Turkey', N'A dish popular across the Middle East, Kebabs are originally from Turkey. They consist of ground meat or seafood, fruits, and vegetables in some cases and are cooked on a skewer with a big fire underneath, just like a barbeque on the grill.', 300, N'https://www.holidify.com/images/cmsuploads/compressed/bacon-kebabs-13-2_20181227133457.jpg', 1)
GO
